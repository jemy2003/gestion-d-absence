...
📊 Consultation des historiques de présence via l’interface web.
...
PHP — pour la logique côté serveur et la gestion des requêtes HTTP.

HTML / CSS / Bootstrap — pour le design et la structure de l’interface utilisateur.

JavaScript — pour les interactions dynamiques et la capture vidéo.

MySQL / phpMyAdmin — pour le stockage et la gestion des données de présence.
